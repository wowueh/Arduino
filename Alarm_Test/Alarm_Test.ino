...
void setup(void)
{
  ...
  RTC.setAlarm(ALM1_EVERY_SECOND, 0, 5, 7, 5);    //daydate parameter should be between 1 and 7
  RTC.alarm(ALARM_1);                   //ensure RTC interrupt flag is cleared
  RTC.alarmInterrupt(ALARM_1, true);

  //Set an alarm every minute.
  RTC.setAlarm(ALM2_EVERY_MINUTE, 0, 0, 0, 5);    //daydate parameter should be between 1 and 7
